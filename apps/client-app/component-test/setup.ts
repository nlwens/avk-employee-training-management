...
export const mockT = vi.fn(
  (selector: string | (($: Record<string, unknown>) => unknown)) => {
...
// PersistQueryClientProvider accesses IndexedDB via idb-keyval. jsdom does not
// implement IndexedDB, so we need to mock the library.
vi.mock("idb-keyval", () => ({
